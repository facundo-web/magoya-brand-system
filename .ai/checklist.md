...
| 10 | **Máximo 2 recursos gráficos** | Contá: foto aérea, foto B&N, personaje, motivo, marca a mano, ícono | Hay 3 o más además de la tipografía, o convive un par prohibido (foto + personaje, foto + motivo, personaje + ícono, foto + foto) |
| 11 | **Motivo al corte** | Mirá los bordes del motivo de semicírculos | El motivo se ve cortado flotando en el aire en vez de nacer de un borde o de detrás de un objeto |
