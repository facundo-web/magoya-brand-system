...
| F60 | *"Integrar con AI es re poderoso para lo que queremos hacer internamente... ¿no podría ser parte de la propuesta de la home?"* | Sugiere agregar una celda/sección en `index.html` que promocione "Integrar con AI" como un pilar de valor, no solo como un ítem de nav más. Depende de la dirección que se tome en F56 (el rediseño de la home) | Mediano, y conviene resolverlo junto con F56, no antes |
